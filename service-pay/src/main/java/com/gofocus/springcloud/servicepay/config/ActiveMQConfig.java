package com.gofocus.springcloud.servicepay.config;
...
public class ActiveMQConfig {
     ...
     */
    @Bean
    public JmsListenerContainerFactory jmsListenerContainerFactory(@Qualifier("connectionFactory") ActiveMQConnectionFactory activeMQConnectionFactory){
